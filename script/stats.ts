...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/rabelojunior81-collab/argenta-tui/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for rabelojunior81-collab/argenta-tui...\n")
