export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos disponíveis neste runtime",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Argenta-Tui.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Argenta-Tui.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Argenta-Tui.",
  ...
  "dialog.server.description": "Trocar para qual servidor do Argenta-Tui este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Argenta-Tui ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro no repositório oficial do Argenta-Tui",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Argenta-Tui ainda não suporta autenticação MCP nesta fase.',
  ...
  "sidebar.gettingStarted.line1": "Há modelos gratuitos disponíveis para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor do Argenta-Tui dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Argenta-Tui",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Argenta-Tui aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Argenta-Tui segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize a identidade visual do Argenta-Tui.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Argenta-Tui iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Argenta-Tui.",
