export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models available in this runtime",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Argenta-Tui.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Argenta-Tui.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Argenta-Tui.",
  ...
  "dialog.server.description": "Switch which Argenta-Tui server this app connects to.",
  ...
  "toast.update.description": "A new version of Argenta-Tui ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error in the official Argenta-Tui repository",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Argenta-Tui does not support MCP authentication in this phase yet.',
  ...
  "sidebar.gettingStarted.line1": "Free models are available so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Argenta-Tui server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Argenta-Tui",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Argenta-Tui looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Argenta-Tui follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise the visual identity of Argenta-Tui.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Argenta-Tui launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Argenta-Tui.",
