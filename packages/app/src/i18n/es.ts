export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos disponibles en este runtime",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Argenta-Tui.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Argenta-Tui.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Argenta-Tui.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Argenta-Tui se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Argenta-Tui ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error en el repositorio oficial de Argenta-Tui",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Argenta-Tui todavía no soporta autenticación MCP en esta fase.',
  ...
  "sidebar.gettingStarted.line1": "Hay modelos gratuitos disponibles para que puedas empezar inmediatamente.",
  ...
  "app.name.desktop": "Argenta-Tui Desktop",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor de Argenta-Tui dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Argenta-Tui",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Argenta-Tui en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Argenta-Tui sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza la identidad visual de Argenta-Tui.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Argenta-Tui",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Argenta-Tui.",
