export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Argenta-Tui",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Argenta-Tui foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Argenta-Tui",
  "desktop.menu.help.supportForum": "Issues no GitHub",
  "desktop.menu.help.shareFeedback": "Compartilhar feedback no GitHub",
  "desktop.menu.help.reportBug": "Relatar um bug no GitHub",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Argenta-Tui está ausente. Tente reinstalar o aplicativo de desktop.",
