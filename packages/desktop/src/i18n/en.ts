export const dict = {
  ...
  "desktop.menu.help.documentation": "Argenta-Tui Documentation",
  "desktop.menu.help.supportForum": "GitHub Issues",
  "desktop.menu.help.shareFeedback": "Share Feedback on GitHub",
  "desktop.menu.help.reportBug": "Report a Bug on GitHub",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Argenta-Tui",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Argenta-Tui has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "Argenta-Tui CLI binary is missing. Try reinstalling the desktop app.",
