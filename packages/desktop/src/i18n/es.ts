export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Argenta-Tui",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Argenta-Tui. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Argenta-Tui",
  "desktop.menu.help.supportForum": "Issues en GitHub",
  "desktop.menu.help.shareFeedback": "Compartir comentarios en GitHub",
  "desktop.menu.help.reportBug": "Informar de un error en GitHub",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Argenta-Tui. Intenta reinstalar la aplicación de escritorio.",
