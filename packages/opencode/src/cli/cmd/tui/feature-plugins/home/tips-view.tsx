...
const TIPS = [
  ...
  "Use {highlight}/share{/highlight} to criar um link público para sua conversa",
  ...
  "Coloque as configurações TUI em {highlight}~/.config/opencode/tui.json{/highlight} para config global",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "Argenta auto-gerencia OAuth para servidores MCP remotos que requerem autenticação",
  ...
  "Argenta auto-formata arquivos com prettier, gofmt, ruff e mais",
  'Configure {highlight}"formatter": false{/highlight} para desativar a formatação automática',
  "Define custom formatter commands with file extensions in config",
  "Argenta usa servidores LSP para análise inteligente de código",
  ...
  "Use {highlight}argenta run{/highlight} para scripting não-interativo",
  "Use {highlight}argenta --continue{/highlight} para retomar a última sessão",
  "Use {highlight}argenta run -f file.ts{/highlight} para anexar arquivos via CLI",
  "Use {highlight}--format json{/highlight} para saída legível por máquinas em scripts",
  "Execute {highlight}argenta serve{/highlight} para acesso headless à API",
  "Use {highlight}argenta run --attach{/highlight} para conectar a um servidor em execução",
  "Execute {highlight}argenta upgrade{/highlight} para atualizar para a versão mais recente",
  "Execute {highlight}argenta auth list{/highlight} para ver todos os provedores configurados",
  "Execute {highlight}argenta agent create{/highlight} para criação guiada de agente",
  "Use {highlight}/argenta{/highlight} em issues/PRs do GitHub para acionar ações de IA",
  "Execute {highlight}argenta github install{/highlight} para configurar o workflow do GitHub",
  "Comente {highlight}/argenta fix this{/highlight} em issues para auto-criar PRs",
  "Comente {highlight}/ac{/highlight} em linhas de PR para revisões de código direcionadas",
  ...
  "Use {highlight}/connect{/highlight} para conectar 75+ provedores de IA disponíveis",
